...
def main(): 
    ...
    while(finalizador <= rolete):
        ...
        time.sleep(2.5) #Espera 1.5 segundos para forjar o item
        ...
        TotalNum = adds.count("Tempo")
        print(adds.count("Tempo"))

        if TotalNum >= Quant:
            pyautogui.click(BotaoReproduzir[0]+155,BotaoReproduzir[1]-15) #CLica em segurar o novo add
            pyautogui.alert('Parabéns, conseguimos uma parte do set com '+ str(TotalNum) +' add de Invocação','I.A do John','Obrigado')
