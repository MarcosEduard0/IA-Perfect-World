...
def main():
    ...
    while(finalizador <= TotalRolete): #Faça enquanto tiver reliquia no bag
        ...
        area = (AddPosition[1][0]+90, AddPosition[1][1]+44, AddPosition[1][0]+140, AddPosition[1][1]+140) #Defino o tamanho e o local da area a ser corada na imagem
        ...
        nove = teste.count("9") + teste.count("49") + teste.count('0')
        dez = teste.count("10") + teste.count("40")
        print('9%: ', nove)
        print('10%: ', dez)
        print("\n--------------------------------------------\n")

        if dez >= 3:
            pyautogui.alert('Conseguimos full 10.\n','I.A do John', 'OK')
            exit()
