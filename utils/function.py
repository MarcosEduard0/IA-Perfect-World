...
def LocateButton(path_img_botao, path_img_botao_2=""):

    BotaoReproduzir = pyautogui.locateCenterOnScreen(path_img_botao, confidence=0.9)

    if BotaoReproduzir == None:
        BotaoReproduzir = pyautogui.locateCenterOnScreen(path_img_botao, confidence=0.9)
        if BotaoReproduzir == None:
            pyautogui.alert(
                "Erro ao localizar o botão reproduzir, verifique se você abriu a janela de Reprodução de Equipamento.\n"
...
def LocateButtonAvatar():
    ...
    BotaoAvatar = pyautogui.locateCenterOnScreen(
        r"image\botaoAvatar.png", confidence=0.8
    )
    if BotaoAvatar == None:
...
def LocateTaskBarPw():
    ...
    if pw == None:
        pyautogui.alert(
            "Erro ao localizar o Perfect World na barra de tarefas.\n",
            "I.A do John",
            "OK",
        )
        input("Presione Enter para fechar....")
...
def LocateWindowPw():
    ...
    if window == None:
        pyautogui.alert(
            "Erro ao localizar as janelas do Perfect World.\n", "I.A do John", "OK"
        )
        input("Presione Enter para fechar....")
        exit()
...
def LocateCupom():
    ...
    if cupom == None:
        pyautogui.alert(
            "Erro ao localizar os cupons no seu inventário.\n", "I.A do John", "OK"
        )
        input("Presione Enter para fechar....")
        exit()
...
def LocateCoin():
    ...
    if coin == None:
        pyautogui.alert(
            "Erro ao localizar derrubar moedas no seu inventário.\n",
            "I.A do John",
            "OK",
        )
        input("Presione Enter para fechar....")
...
def LocateButtonMax():
    ...
    if buttonMax == None:
        pyautogui.alert(
            'Erro ao localizar o botão "Máximo" no soltar moedas.\n',
            "I.A do John",
            "OK",
        )
        input("Presione Enter para fechar....")
...
def LocateFechar():
    ...
    if fechar == None:
        pyautogui.alert(
            'Erro ao localizar o botão "fechar" no inventário.\n', "I.A do John", "OK"
        )
        input("Presione Enter para fechar....")
        exit()
...
def LocatePegar():
    ...
    if pegar == None:
        ...
        if pegar == None:
            pyautogui.alert(
                'Erro ao localizar o botão "Pegar itens e Ganância" na barra. Verifique se lembrou de coloca-las\n',
                "I.A do John",
                "OK",
            )
            input("Presione Enter para fechar....")
...
def LocateButtonVender():
    ...
    if button == None:
        button = pyautogui.locateCenterOnScreen(
            r"image\botaoVender.png", confidence=0.9
        )
        if button == None:
...
def LocateButtonReforja():
    ...
    if button == None:
        button = pyautogui.locateCenterOnScreen(
            r"image\botaoReforja.png", confidence=0.9
        )
        if button == None:
...
def LocateSetPosition():
    ...
    if posicao == None:
        pyautogui.alert(
            "Erro ao localizar a posição do equipamento.\n", "I.A do John", "OK"
        )
        input("Presione Enter para fechar....")
        exit()
...
def LocateAddPosition():
    ...
    if posicao == []:
        posicao = list(
            pyautogui.locateAllOnScreen(r"image\LocateAdd2.png", confidence=0.9)
        )
        if posicao == []:
            pyautogui.alert(
                "Erro ao localizar a posição dos atributos do set.\n",
                "I.A do John",
                "OK",
            )
            input("Presione Enter para fechar....")
